...
BEGIN
  ...
  SELECT coalesce(jsonb_agg(jsonb_build_object(
           ...
           'priorVersion', transition.prior_version,
           'resultingVersion', transition.resulting_version,
  ...
  RETURN jsonb_build_object('order', jsonb_build_object(
    ...
    'aggregateVersion', order_row.aggregate_version,
...
SET LOCAL ROLE application_writer_owner;
GRANT EXECUTE ON FUNCTION etf.job_get(uuid), etf.paper_order_get(uuid) TO app_runtime;
SET LOCAL ROLE projection_owner;
