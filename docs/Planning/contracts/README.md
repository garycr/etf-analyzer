...
| Prototype surface inventory | `docs/Planning/contracts/prototype-surface-inventory.md` | #21 | `1.0.0-candidate.4`; REV-098 synchronizes OpenAPI candidate.3 and WP-4 implementation; all eight minimum categories inventoried |
| Fixture input | `docs/Planning/contracts/fixture-contract.md` | #17, #21 | `1.0.0-candidate.2`; `PT-FIX-001A..O` executable in WP-2; REV-059 conditional PASS; #71 required before non-golden WP-3 ingestion |
| Application boundary | `docs/Planning/contracts/application-contract.md` | #21, #22 | `1.0.0-candidate.2`; `PT-APP-001A..P` executable in WP-3; aggregate REV-094/095/096/097 PASS and DEC-037 closure; #22 remains open for broader NFR scope |
| REST/OpenAPI | `docs/Planning/contracts/openapi-contract.yaml` | #14, #17, #21, #22, #75, #76 | `1.0.0-candidate.3`; executable `CT-API-001A..L`; REV-098/099 PASS and REV-100 conditional PASS; WP-4 closed |
| Durable storage / PostgreSQL | `docs/Planning/contracts/postgresql-contract.md` | #15, #17, #20, #9 | `1.0.0-candidate.2` final Team Lead custody PASS and REV-026 independent PASS; six WP-1 migrations/hashes executed; A/B/C/L and D/K foundation leaves evidenced; domain and integrated `CT-DB-001A..L` acceptance remains allocated through WP-8 |
...
| Prototype surface inventory | Candidate; implementation agreement through WP-4 | `1.0.0-candidate.4`; REV-098 synchronizes OpenAPI candidate.3 and the executable API surface |
| Fixture input contract | Executable for the approved golden fixture path | Candidate `1.0.0-candidate.2`; identity/hash, vintage/order, DEC-014 decimal, provenance, DQ suppression, and `PT-FIX-001A..O` pass REV-059; #71 blocks non-golden WP-3 ingestion |
...
| REST/OpenAPI contract | WP-4 conditionally closed | Candidate `1.0.0-candidate.3`; closed 16-operation loopback surface plus fixed Problem500; REV-098/099 PASS and REV-100 conditional PASS |
| Durable storage / PostgreSQL contract | Physical implementation complete; integrated acceptance pending | Candidate `1.0.0-candidate.2`; six native PostgreSQL 16 migrations and exact hashes executed; A/B/C/L and D/K foundation leaves evidenced; complete readers and remaining domain leaves close in owning packages; integrated `CT-DB-001A..L` closes in WP-8 |
